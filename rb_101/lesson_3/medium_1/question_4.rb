...
- the invocation of the `#+` method in `rolling_buffer2` doesn't mutate the local variable `input_array` on line 33.
=end
...
rolling_buffer1(buffer, max_buffer_size, new_element)
# => [2, 3, 4, 5, 6]
buffer
# => [2, 3, 4, 5, 6]
...
rolling_buffer2(input_array, max_buffer_size, new_element)
# => [2, 3, 4, 5, 6]
input_array
# => [1, 2, 3, 4, 5]
