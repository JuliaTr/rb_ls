...
module Mailing
  ...
  # Before: `send` (accidental overriding Ruby built-in method `Object#send`)
  # After (renamed in order not to override `Object#send`):
...
rafael_email_account = EmailService.new('Rafael', 111, 'Rafael@example.com')
...
#<PostalService:0x000000010889c048 @name="John", 
@account_number=nil, @street_address="47 Sunshine Ave.", 
@mailbox=[]> (NoMethodError)
=end

# After: Sending Postcard from John to: 860 Blackbird Ln.
