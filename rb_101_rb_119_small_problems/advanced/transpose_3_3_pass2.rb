...
def transpose(matrix)
  ...
  # Access elements. From each subarray:
  # Take 0 indexed element
  new_matrix << [matrix[0][0], matrix[1][0], matrix[2][0]]
  # p new_matrix  # => [[1, 4, 3]]

  # Take 1 indexed element
  new_matrix << [matrix[0][1], matrix[1][1], matrix[2][1]]
  # p new_matrix  # => [[1, 4, 3], [5, 7, 9]]

  # Take 2 indexed element
  new_matrix << [matrix[0][2], matrix[1][2], matrix[1][2]]

  new_matrix     # [[1, 4, 3], [5, 7, 9], [8, 2, 2]]
end
