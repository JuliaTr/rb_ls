=begin
Sort an array of passed in values using merge sort. You can 
assume that this array may contain only one type of data, and 
that data may be either all numbers or all strings.
...
those nested sub-arrays in sorted order. It is best shown by 
example.
=end
