...
{{"d"=>1, "e"=>1, "m"=>1, "o"=>1}=>["demo"], 
{"n"=>2, "o"=>1, "e"=>1}=>["none"], 
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied"]}

{"e"=>1, "v"=>1, "i"=>1, "l"=>1}
{{"d"=>1, "e"=>1, "m"=>1, "o"=>1}=>["demo"], 
{"n"=>2, "o"=>1, "e"=>1}=>["none"], 
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil"]}

{"d"=>1, "o"=>1, "m"=>1, "e"=>1}
{{"d"=>1, "e"=>1, "m"=>1, "o"=>1}=>["demo", "dome"], 
{"n"=>2, "o"=>1, "e"=>1}=>["none"], 
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil"]}

{"m"=>1, "o"=>1, "d"=>1, "e"=>1}
{{"d"=>1, "e"=>1, "m"=>1, "o"=>1}=>["demo", "dome", "mode"], 
{"n"=>2, "o"=>1, "e"=>1}=>["none"], 
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil"]}
...
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil", "live"], 
{"f"=>1, "o"=>1, "w"=>1, "l"=>1}=>["fowl"]}

{"v"=>1, "e"=>1, "i"=>1, "l"=>1}
{{"d"=>1, "e"=>1, "m"=>1, "o"=>1}=>["demo", "dome", "mode"], 
{"n"=>2, "o"=>1, "e"=>1}=>["none"], 
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil", "live", "veil"], 
{"f"=>1, "o"=>1, "w"=>1, "l"=>1}=>["fowl"]}
...
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil", "live", "veil"], 
{"f"=>1, "o"=>1, "w"=>1, "l"=>1}=>["fowl", "wolf"]}

{"d"=>1, "i"=>1, "e"=>1, "t"=>1}
{{"d"=>1, "e"=>1, "m"=>1, "o"=>1}=>["demo", "dome", "mode"], 
{"n"=>2, "o"=>1, "e"=>1}=>["none"], 
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied", "diet"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil", "live", "veil"], 
{"f"=>1, "o"=>1, "w"=>1, "l"=>1}=>["fowl", "wolf"]}
...
{"n"=>2, "o"=>1, "e"=>1}=>["none"], 
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied", "diet"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil", "live", "veil", "vile"], 
{"f"=>1, "o"=>1, "w"=>1, "l"=>1}=>["fowl", "wolf"]}

{"e"=>1, "d"=>1, "i"=>1, "t"=>1}
{{"d"=>1, "e"=>1, "m"=>1, "o"=>1}=>["demo", "dome", "mode"], 
{"n"=>2, "o"=>1, "e"=>1}=>["none"], 
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied", "diet", "edit"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil", "live", "veil", "vile"], 
{"f"=>1, "o"=>1, "w"=>1, "l"=>1}=>["fowl", "wolf"]}
...
{{"d"=>1, "e"=>1, "m"=>1, "o"=>1}=>["demo", "dome", "mode"], 
{"n"=>2, "o"=>1, "e"=>1}=>["none"], 
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied", "diet", "edit", "tide"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil", "live", "veil", "vile"], 
{"f"=>1, "o"=>1, "w"=>1, "l"=>1}=>["fowl", "wolf"]}
...
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied", "diet", "edit", "tide"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil", "live", "veil", "vile"], 
{"f"=>1, "o"=>1, "w"=>1, "l"=>1}=>["fowl", "wolf", "flow"]}

{"n"=>2, "e"=>1, "o"=>1}
{{"d"=>1, "e"=>1, "m"=>1, "o"=>1}=>["demo", "dome", "mode"], 
{"n"=>2, "o"=>1, "e"=>1}=>["none", "neon"], 
{"t"=>1, "i"=>1, "e"=>1, "d"=>1}=>["tied", "diet", "edit", "tide"], 
{"e"=>1, "v"=>1, "i"=>1, "l"=>1}=>["evil", "live", "veil", "vile"], 
{"f"=>1, "o"=>1, "w"=>1, "l"=>1}=>["fowl", "wolf", "flow"]}
=end
