...
be formed between the elements of the two Arrays. The 
...
def multiply_all_pairs(arr1, arr2)
  ...
  arr2.each do |item|
    products << item * arr1[0]
    products << item * arr1[1]
  end
...
def multiply_all_pairs(array_1, array_2)
  ...
  array_2.each do |item_1|
    array_1.each do |item_2|
      products << item_1 * item_2
    end
  end
