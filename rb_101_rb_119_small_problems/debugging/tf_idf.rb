...
TF-IDF for information exraction, a measure of the information content 
...
performing division. Remove document1 from the documents 
...
puts tfidf("quantum", document1, documents)
puts tfidf("quantum", document2, documents)
puts tfidf("quantum", document3, documents)

puts tfidf("mastery", document1, documents)
puts tfidf("mastery", document2, documents)
puts tfidf("mastery", document3, documents)

puts tfidf("some", document1, documents)
puts tfidf("some", document2, documents)
puts tfidf("some", document3, documents)
