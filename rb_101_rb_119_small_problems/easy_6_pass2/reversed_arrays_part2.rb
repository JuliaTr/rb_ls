...
# the elements of the original list in reverse order. Do not 
...
# def reverse(arr)
#   reversed = []
#   (arr.size - 1).downto(0) { |idx| reversed << arr[idx] }
#   reversed
# end
...
def reverse(arr)
  counter = arr.size - 1
  arr.each_with_object([]) do |_, reversed|
    reversed << arr[counter]
    counter -= 1
  end
end
